...
2. Lancez : `python backend/scripts/batch_ocr.py svt/2020-rattrapage`
3. Découpez manuellement les documents du sujet et placez-les dans `assets/` avec le nommage `docXpY.png`
4. Lancez : `python backend/scripts/batch_build_json.py svt/2020-rattrapage`
