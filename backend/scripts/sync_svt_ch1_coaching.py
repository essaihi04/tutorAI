...
def resource_rows(energy_id: str, muscle_id: str) -> list[dict]:
    return [
        ...
        },
        {
            ...
            "description": "Coupe 3D sans légendes pour faire identifier membranes, crêtes et matrice.",
            ...
            "trigger_text": "observe mitochondrie 3d",
            "phase": "explanation",
            "difficulty_tier": "beginner",
            "concepts": ["mitochondrie", "crêtes", "matrice"],
            "metadata": {"caption": "Reconstitution pédagogique – illustration générée", "source_type": "ai_generated_reconstruction", "interaction": "identifier_avant_legendes"},
            "order_index": 30,
        },
        {
            "lesson_id": energy_id,
