...
BEGIN
    ...
    VALUES
        ...
        (lesson_id, 'Respiration cellulaire', 'simulation', 'Mitochondrie 3D à observer', 'Modèle 3D manipulable : rotation, zoom et mise en évidence des membranes, crêtes et matrice.', '/media/images/svt/ch1_consommation_matiere_organique/lesson_1_liberation_energie/respiration/mitochondrie_3d_sans_legendes.png', 'observe et manipule mitochondrie 3d', 'explanation', 'beginner', jsonb_build_array('mitochondrie', 'crêtes', 'matrice', 'ADN mitochondrial'), jsonb_build_object('visual_kind', 'scientific', 'scientific', jsonb_build_object('engine', 'three', 'model', 'mitochondrion', 'title', 'Mitochondrie 3D interactive', 'description', 'Double membrane, crêtes, matrice et ADN mitochondrial circulaire.', 'autoplay', true, 'labels', true, 'focus', 'all'), 'caption', 'Modèle pédagogique manipulable', 'source_type', 'versioned_scientific_model', 'interaction', 'rotate_zoom_focus', 'library_status', 'published'), 30),
